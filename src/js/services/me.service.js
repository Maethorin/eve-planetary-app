...
evePlanetaryServices.service('MeService', ['$rootScope', '$q', '$window', 'AuthService', '$location', '$stateParams', 'Redirect', 'Alert', 'Me', function ($rootScope, $q, $window, AuthService, $location, $stateParams, Redirect, Alert, Me) {
  var info = null;
  var loading = false;
